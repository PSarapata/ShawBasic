...
PHRASES = {
    ...
    "class %%%(object):\n\tdef __init__(self, ***)":
        "Klasa %%% ma __init__, który przyjmuje parametry self i ***.",
    "class %%%(object):\n\tdef ***(self, @@@)":
...
def convert(snippet, phrase):
    ...
    for sentence in snippet, phrase:
        # copy of a sentence using a slice...
        result = sentence[:]
...
# This loop is going to be infinite so we'll have to break by Ctrl+Z or Ctrl+D
try:
    while True:
